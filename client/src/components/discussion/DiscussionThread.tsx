      ...
      {showNewThreadForm && (
        <Card>
          ...
          <Space direction="vertical" className="w-full" size="middle" style={{ marginTop: 16 }}>
            ...
            />
            <Space>
              <Button type="primary" onClick={handlePostThread}>
                Post Thread
              </Button>
        ...
        {threads.map((thread) => (
          <Card key={thread.id}>
            <div className="flex gap-4">
              <Avatar src={thread.avatar} size={48}>
                {thread.author[0]}
              </Avatar>
              ...
              <div className="flex-1">
                      ...
                      <div key={reply.id} className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <Button
                            ...
                            icon={<LikeOutlined />}
                            size="small"
                            style={{ marginTop: 4, height: 24, padding: '0 8px' }}
                          >
                            {reply.likes}
                          </Button>
                        </div>
                ...
                {showReplyForm === thread.id && (
                  <div className="mt-4 flex gap-2">
                    <Avatar src={guestUser.avatar} size={32}>
                      {guestUser.name[0]}
                    </Avatar>
                    <div className="flex-1">
                      <TextArea placeholder="Write your reply..." rows={3} style={{ marginBottom: 8 }} />
                      <Space>
                        <Button
                          type="primary"
                          size="small"
