...
export const fetchStudentDashboard = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get(`${API_BASE}/students`, { withCredentials: true });
...
export const fetchInstructorDashboard = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get(`${API_BASE}/instructors`, { withCredentials: true });
      return res.data.data ?? res.data ?? {};
    } catch (err: any) {
...
export const fetchAdminDashboard = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get(`${API_BASE}/admin`, { withCredentials: true });
...
export const fetchSuperAdminDashboard = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get(`${API_BASE}/superadmins`, { withCredentials: true });
      return res.data.data ?? res.data ?? {};
    } catch (err: any) {
